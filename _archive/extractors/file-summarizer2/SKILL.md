---
name: file-summarizer2
description: "Trigger: /file-summarizer2 <absolute-file-path>. Read a local .txt file and output a 3–5 sentence summary plus key topics."
---
...
### Trigger
- `/file-summarizer2 <absolute-file-path>`
...
```bash
/opt/anaconda3/bin/python3 /Users/igorsilva/clawd/skills/skillmd-builder-agent/scripts/validate_skillmd.py   /Users/igorsilva/clawd/skills/file-summarizer2/SKILL.md
```
Expected: `PASS`.

5. **No invented tools**
```bash
/opt/anaconda3/bin/python3 /Users/igorsilva/clawd/skills/skillmd-builder-agent/scripts/check_no_invented_tools.py   /Users/igorsilva/clawd/skills/file-summarizer2/SKILL.md
```
Expected: `PASS`.
...
- /Users/igorsilva/clawd/skills/file-summarizer/SKILL.md
